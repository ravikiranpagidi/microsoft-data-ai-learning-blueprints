...
- [sample-data/customers.csv](https://github.com/ravikiranpagidi/fabric-data-engineering-blueprint/blob/main/sample-data/customers.csv)
- [sample-data/accounts.csv](https://github.com/ravikiranpagidi/fabric-data-engineering-blueprint/blob/main/sample-data/accounts.csv)
- [sample-data/products.csv](https://github.com/ravikiranpagidi/fabric-data-engineering-blueprint/blob/main/sample-data/products.csv)
- [sample-data/branches.csv](https://github.com/ravikiranpagidi/fabric-data-engineering-blueprint/blob/main/sample-data/branches.csv)
- [sample-data/transactions.csv](https://github.com/ravikiranpagidi/fabric-data-engineering-blueprint/blob/main/sample-data/transactions.csv)
