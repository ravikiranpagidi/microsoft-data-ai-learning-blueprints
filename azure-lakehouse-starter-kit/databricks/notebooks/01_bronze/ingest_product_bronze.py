...
# MAGIC %md
# MAGIC # 01 - Bronze Ingestion: Products
# MAGIC
# MAGIC Reads raw product CSV files and writes an append-only Bronze Delta table.
...
source_path = f"{raw_base_path}/products"
target_table = f"{catalog}.bronze.brz_products"
